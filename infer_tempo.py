...
def calculate_motion_vector_angles(
    ...
    # initialize optical flow angles lists
    optical_flow_angles = list()
    ...
    for _ in range(frame_count - 1):
        ...
        optical_flow_angles.append(faircloth_tempo(flow))
        previous_frame_greyscale = current_frame_grayscale

    return np.convolve(optical_flow_angles, np.ones(convolve_param), mode='full')
...
def agent_factory(
    ...
    """
    A factory for agents in the tempo inference algo.
